...
function InfMPS(eltype::Type{<:Number}, s::Vector, f::Function, translator::Function=translatecelltags, )
...
function UniformMPS(eltype::Type{<:Number}, s::CelledVector, f::Function; left_dir=ITensors.Out)
  sᶜ¹ = s[Cell(1)]
